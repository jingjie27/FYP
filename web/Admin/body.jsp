        ...
        <!-- <div class="main-container"> -->
            <div class="pd-ltr-20">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <h4 class="font-20 weight-500 mb-10 text-capitalize">
                                Welcome back <div class="weight-600 font-30 text-blue"><%= loginUser.getString("FIRST_NAME") %> <%= loginUser.getString("LAST_NAME") %>!</div>
                            </h4>
                ...
                <div class="footer-wrap pd-20 mb-20 card-box">
                    Admin Back Office System <br/> Powered by <strong>AURORA ERP</strong>
                </div>
            </div>
        <!-- </div> -->
    </body>
