...
<html>
    ...
    <head>
        ...
        <!-- Basic Page Info -->
        <title>AURORA PaymentSearch</title>
    ...
    <%!
        ...
        private static final String PAGE_TITLE = "Payment Report"; // Header Name for search
        ...
        <script>
            function populateTable(dataArray, pageInfo) {
                ...
                table.on('click', "td.detail-btn", function () {
                    ...
                    window.location.href = '<%= WebMisc.getCoreIP()%>/Admin/PY/paymentDetail.jsp';
