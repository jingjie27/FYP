...
public class UserMngCreateBean {
    ...
    public String toString() {
        return "UserMngCreateBean{" + "userID=" + userID + ", userPsw=" + userPsw + ", userPin=" + userPin + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", contactNumber=" + contactNumber + ", allowVoid=" + allowVoid + ", title=" + title + ", authorization=" + authorization + ", dateCreate=" + dateCreate + ", createBy=" + createBy + ", userStatus=" + userStatus + '}';
    }
