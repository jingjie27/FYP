...
public class UserMngResult extends GenericSearch {
    ...
    public String toString() {
        return "UserMngResult{" + "userID=" + userID + ", userPsw=" + userPsw + ", userPin=" + userPin + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + ", contactNumber=" + contactNumber + ", allowVoid=" + allowVoid + ", title=" + title + ", authorization=" + authorization + ", dateCreate=" + dateCreate + ", createBy=" + createBy + ", userStatus=" + userStatus + ", lastVersion=" + lastVersion + '}';
    }
